<template>
	...
	<div class="template_root"><input style="width:200px;color:#fff" :value="1232" />
		...
		<div class="lg-row width-limt select_robot_div" style="width: 1400px;margin: 0 auto;">
			...
			<div class="row lg-row select_robot_box">
				...
				<!-- Card -->
				<div class="lg-width chartBox"  v-for="(list,index) in robotInfoList" :key="index" :class="{'chartbox-right':index==2||index==5}" >
			...
			<div v-show="userType==3"><!--专业用户   显示组件列表-->
				...
				<div class="row lg-row select_robot_box">
					...
					<!-- Card -->
					<div class="lg-width" :class="changeChartbox(index)" style="height: 228px;" v-for="(list,index) in componentList" :key="index">
			...
			<div v-show="userType==3"><!--专业版用户 策略块展示-->
				...
				<div class="row lg-row select_robot_box">
					...
					<!-- Card -->
					<div class="lg-width " :class="changeChartbox(index)" style="height: 275px;position: relative;" v-for="(list,index) in strategyList" :key="index">
								...
								<div style="display: table;width: 100%;border-bottom:1px solid #718EBD;">
									...
									<div class="lg-width" style="width: 70%;margin-top: 25px;text-align: left;margin-left: 5%;">
										<select autocomplete="off" class="exchange" style="width: 280px;line-height: 35px;border: none;background: none;font-size: 16px;color: #fff;" @change="initAccount(buyRbtParams.account_id)" v-model="buyRbtParams.account_id">
											...
											<option style="text-align: center;background: #006DCC;" v-for="items in buyInfo.accounts" :value="items.Id" :key="items.Id">{{ items.ExchangeAccountName }}</option>
										</select>
									</div>
								</div>
								<div style="display: table;width: 100%;border-bottom:1px solid #718EBD;">
