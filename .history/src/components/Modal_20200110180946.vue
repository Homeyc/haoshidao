  ...
  >
    ...
    <div class="modal-dialog" v-show="isLogin==1">
      <div class="modal-content login-box">
        <div
          class="row lg-row"
          style="margin-top: 20px;margin-left: 0px;margin-right: 0px;border-bottom: 1px #ffffff1a solid;"
        >
          <div class="lg-width" style="width: 50%;text-align: center;">
            <div class="panel-body1" v-bind:class="{ 'lg-checked':isCom }">
              <a
                ...
                v-bind:class="{ 'bm-checkbox':isCom }"
                @click="toCommon"
              >{{$t('net.accountlogin')}}</a>
            </div>
          </div>
          <div class="lg-width" style="width: 50%;text-align: center;">
            <div class="panel-body1" v-bind:class="{ 'lg-checked':isMess }">
              <a
                class="netlg-ac"
                style="cursor: pointer;"
                v-bind:class="{ 'bm-checkbox':isMess }"
                @click="toMessage"
              >{{$t('net.SMSlogin')}}</a>
            </div>
          </div>
        ...
        <div v-show="isCom">
          <div class="row lg-row" style="margin-top: 30px;width: 80%;margin-left: 10%;">
            ...
            <div class="lg-width" style="width:100%;">
              <input
                type="text"
                @keyup.enter="toLoginU"
                class="form-control lg-border"
                autocomplete="off"
                :placeholder="$t('netnew.sjhhyx')"
          ...
          <div class="row lg-row" style="margin-top: 25px;width: 80%;margin-left: 10%;">
            <div class="lg-width" style="width:64%">
              <input
                ...
                :placeholder="$t('net.verificationCode')"
              />
              <!--<input type="text" id="isCk"  style="display: none;">-->
            </div>
            <div
              class="lg-width"
              style="width: 36%;text-align: center;height: 40px;background: #fff;"
            >
          ...
          <div class="row lg-row" style="margin-top: 30px;width: 80%;margin-left: 10%;">
            <div class="lg-width" style="width:67%;">
              <input
                ...
                type="checkBox"
                @click="changeFreeWeek"
                checked="checked"
              />
              <label
                style="margin-left: 6px;color:#718EBD;"
                @click="changeFreeWeek2"
              >{{$t('net.nologinweek')}}</label>
            </div>
            ...
            <div class="lg-width" style="width: 32%;text-align: right;">
              <a
                @click="toForgetpw"
                style="font-weight: initial;color:#718EBD;cursor: pointer;"
              >{{$t('net.forgetpw')}}?</a>
            </div>
          </div>
          <div
            class="row lg-row"
            style="margin-top: 40px;width: 80%;margin-left: 10%;text-align: center;position: relative;"
          >
            <img
              class
              @click="toLoginU"
              style="position: absolute;top: 0px;left:25%;width: 50%;height: 60px;cursor: pointer;"
              src="../assets/img/zcbtn@2x.png"
            />
            <button
              id="btn"
              class="btn lg-lgbt"
          ...
          <div class="row lg-row" style="margin-top: 30px;width: 80%;margin-left: 10%;">
            <div class="lg-width" style="width: 100%;text-align: center;">
              ...
              <span
                style="font-weight: initial;color: #fff;margin-top: 2px;"
              >{{$t('net.noAcRgNow')}}</span>
              <a
                style="font-weight: initial;color: #718EBD;cursor: pointer;margin-top: 2px;text-decoration: underline;"
                @click="toRegister"
              >{{$t('net.regNow')}}</a>
            </div>
          </div>
        ...
        <div v-show="isMess">
          ...
          <div class="row lg-row" style="margin-top: 20px;width: 80%;margin-left: 10%;">
            ...
            <div class="lg-width" style="width:30%;text-align: center;">
              <button
                id="btn"
                style="height: 40px;"
                class="btn bt-getcode"
                type="button"
                @click="getMessage('2')"
              >
                <span v-show="isGet">{{$t('net.send')}}</span>
                <span v-show="!isGet">({{messageCD}}s)</span>
              </button>
            </div>
            <div
              v-show="!isGet"
          ...
          <div
            class="row lg-row"
            style="margin-top: 90px;width: 80%;margin-left: 10%;text-align:center;position: relative;"
          >
            <img
              class
              @click="toLoginM"
      ...
      <div class="modal-content login-box">
        ...
        <div class="row lg-row" style="margin-top: 25px;margin-left: 0px;margin-right: 0px;">
          <div class="lg-width" style="width: 50%;text-align: center;">
            <div
              class="panel-body1"
              style="border-bottom:1px #ffffff1a solid ;"
              v-bind:class="{ 'lg-checked':regType==1 }"
            >
              <a
                class="netlg-ac"
                style="cursor: pointer;"
                v-bind:class="{ 'bm-checkbox':regType==1 }"
                @click="chageType(1)"
              >{{$t('net.phoneregister')}}</a>
            </div>
          </div>
          <!-- <div class="lg-width" style="width: 50%;text-align: center;">
        ...
        <div v-show="regType==1">
          ...
          <div class="lg-row" style="margin-left: 48px;margin-top: 30px;">
            ...
            <label
              ...
              style="font-size: 13px;color: #fff;margin-left: 5px;"
            >
              <span @click="checkPact2">我已阅读并同意遵守</span>
              <a
                @click="toXY"
                style="cursor: pointer;color: #718EBD;text-decoration: underline;"
              >《用户协议》</a>和
              <a
                @click="toXY"
                style="cursor: pointer;color: #718EBD;text-decoration: underline;"
            ...
            <label
              ...
              style="font-size: 13px;color: #fff;margin-left: 5px;"
            >
              <span @click="checkPact2">I have agree to</span>
              <a
                @click="toXY"
                style="cursor: pointer;color: #718EBD;text-decoration: underline;"
              >the terms of use</a> and
              <a
                @click="toXY"
                style="cursor: pointer;color: #718EBD;text-decoration: underline;"
            ...
            <label
              ...
              style="font-size: 13px;color: #fff;margin-left: 5px;"
            >
              <span @click="checkPact2">나는 이미 읽은 후 협의를</span>
              <a
                @click="toXY"
                style="cursor: pointer;color: #718EBD;text-decoration: underline;"
              >사용하는</a> 것에
          ...
          <div
            class="row lg-row"
            style="margin-top: 20px;width: 80%;margin-left: 10%;text-align: center;position: relative;"
          >
            <img
              class
              @click="toPhoneReg"
            ...
            <button
              ...
              type="button"
              :disabled="!pact"
            >{{$t('net.registers')}}</button>
          </div>
          <div
            class="row lg-row"
            style="margin-top: 10px;width: 80%;margin-left: 10%;margin-right: 10%;"
          >
            <div class="lg-width" style="width: 100%;text-align: center;margin-top: 10px;">
              ...
              <a
                style="font-weight: initial;color: #718EBD; cursor: pointer;text-decoration: underline;"
                @click="toLogin"
              >{{$t('net.backLogin')}}</a>
            </div>
          </div>
        ...
        <div v-show="regType==2">
          <div class="row lg-row" style="margin-top: 30px;width: 80%;margin-left: 10%;">
            ...
            <div class="lg-width" style="width:62%;margin-left: 8%;">
              <input
                type="text"
                class="form-control lg-border"
                :placeholder="$t('person.mailAddress')"
                v-model="registerMail.mail"
              />
            </div>
          </div>
          <div class="row lg-row" style="margin-top: 20px;width: 80%;margin-left: 10%;">
          ...
          <div class="row lg-row" style="margin-top: 20px;width: 80%;margin-left: 10%;">
            <div class="lg-width" style="width:100%">
              <input
                type="password"
                class="form-control lg-border"
                :placeholder="$t('net.confirmpassword')"
                v-model="registerMail.repassword"
              />
            </div>
          </div>
          <div class="row lg-row" style="margin-top: 20px;width: 80%;margin-left: 10%;">
          ...
          <div class="lg-row" style="margin-left: 48px;margin-top: 30px;">
            ...
            <label
              ...
              style="font-size: 13px;color: #fff;margin-left: 5px;"
            >
              <span @click="checkPact4">我已阅读并同意遵守</span>
              <a
                @click="toXY"
                style="cursor: pointer;color: #718EBD;text-decoration: underline;"
              >《用户协议》</a>和
            ...
            <label
              ...
              style="font-size: 13px;color: #fff;margin-left: 5px;"
            >
              <span @click="checkPact4">I have agree to</span>
              <a
                @click="toXY"
                style="cursor: pointer;color: #718EBD;text-decoration: underline;"
              >the terms of use</a> and
            ...
            <label
              ...
              style="font-size: 13px;color: #fff;margin-left: 5px;"
            >
              <span @click="checkPact4">나는 이미 읽은 후 협의를</span>
              <a
                @click="toXY"
                style="cursor: pointer;color: #718EBD;text-decoration: underline;"
              >사용하는</a> 것에
    ...
    <div class="modal-dialog" v-show="isLogin==3" id="pwdId">
      <div class="modal-content login-box">
        <div
          class="row lg-row"
          style="border-bottom: 1px #ffffff1a solid;margin-left: 0;margin-right: 0;"
        >
        ...
        <div v-show="step==1">
          ...
          <div
            class="row lg-row"
            style="margin-top: 160px;width: 80%;margin-left: 10%;text-align: center;position: relative;"
          >
            <img
              class
              @click="toNextStep"
          ...
          <div class="row lg-row" style="margin-top: 25px;width: 80%;margin-left: 10%;">
            <div class="lg-width" style="width:100%">
              <input
                ...
                class="form-control lg-border"
                :placeholder="$t('net.confirmpassword')"
                v-model="forgetpwData.repassword"
              />
            </div>
          </div>
          <div
            class="row lg-row"
            style="margin: 0 auto;margin-top: 160px;width:200px;position: relative;"
          >
            <img
              class
              @click="sureModify"
              style="position: absolute;top: 0px;left: 0;width: 100%;height: 100%;cursor: pointer;"
              src="../assets/img/zcbtn@2x.png"
            />
            <button
              id="btn"
    ...
    <div class="modal-dialog" v-show="isLogin==4">
      <div class="modal-content login-box">
        <div
          class="row lg-row"
          style="margin-top: 15px;width: 80%;margin-left: 10%;padding-top: 45px;text-align: center;"
        >
          <img src="../assets/img/group.png" />
        </div>
        <div
          class="row lg-row"
          style="margin-top: 45px;width: 70%;margin-left: 15%;text-align: center;"
        >
          <span style="font-size: 24px;color: #0664da;">
            {{$t('net.regsuccmsg')}}
            <br />
            <span style="color: #e80d0d;">{{$t('net.scqb')}}</span>
          </span>
        </div>
        <div
          class="row lg-row"
      ...
      <div class="modal-content login-box">
        <div class="row lg-row">
          <div style="text-align: center;margin-top: 20px;margin-bottom: 20px;">
            ...
            <span
              v-show="$i18n.locale=='en-US'"
              style="font-size: 18px;color: #718EBD;"
            >Internal Testing Disclaimer</span>
          </div>
        </div>
        <div
          class="row lg-row"
          style="margin-left:0px; margin-right:0px;height: 340px;overflow: auto;padding: 0px 25px 5px 25px;border-bottom: 1px solid #ffffff12;border-top: 1px solid #ffffff12;"
        >
        ...
        <div
          class="row lg-row"
          style="margin: 0 auto;margin-top: 30px;width: 202px;position: relative;background: none !important;"
        >
          <img
            class
            @click="toRegSucc"
    ...
    <div class="modal-dialog" v-show="isLogin==6">
      <div class="modal-content login-box" style="height: 450px;">
        ...
        <div
          class="lg-width"
          style="width: 100%;text-align: center;color: #fff;margin-top:-10px;font-size: 18px;"
        >{{$t('net.regsuccmsg')}}</div>
        <div
          class="lg-width"
          style="width: 100%;text-align: center;color: #718EBD;margin-top:40px;"
        >{{$t('netnew.collect')}}</div>
        <div
          class="lg-width"
        ...
        <div
          class="lg-width"
          style="width: 100%;text-align: center;margin-top: 30px;"
          v-show="$i18n.locale=='en-US' || $i18n.locale=='ko'"
        >
        ...
        >
          ...
          <span
            style="line-height: 25px;color: #718EBD;margin-left: 9px;"
          >{{$t('netnew.weixinScode')}}</span>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    ...
    toLoginU() {
      if (
        ...
        typeof this.loginData.username == "undefined"
      ) {
      ...
      if (
        ...
        typeof this.loginData.password == "undefined"
      ) {
    ...
    toMailReg() {
      ...
      if (
        this.registerMail.password == "" ||
        this.registerMail.password == undefined ||
        typeof this.registerMail.password == "undefined"
      ) {
      ...
      if (
        regData.smid == "" ||
        regData.smid == undefined ||
        typeof regData.smid == "undefined"
      ) {
    ...
    toLoginM() {
      ...
      if (
        loginMdata.smid == "" ||
        loginMdata.smid == undefined ||
        typeof loginMdata.smid == "undefined"
      ) {
        this.$toast.center(this.$t("login.verifycode"));
        return false;
      }
    ...
    toNextStep() {
      if (
        this.forgetpwData.phone == "" ||
        this.forgetpwData.phone == undefined ||
        typeof this.forgetpwData.phone == "undefined"
      ) {
        this.$toast.center(this.$t("login.phoneNull"));
        return false;
      }
      if (
        this.forgetpwData.code == "" ||
        this.forgetpwData.code == undefined ||
        typeof this.forgetpwData.code == "undefined"
      ) {
    ...
    sureModify() {
      if (
        this.forgetpwData.password == "" ||
        this.forgetpwData.password == undefined ||
        typeof this.forgetpwData.password == "undefined"
      ) {
        this.$toast.center(this.$t("login.passNull"));
        return false;
      }
    ...
    toPhoneReg() {
      ...
      if (
        ...
        typeof this.registerData.password == "undefined"
      ) {
        this.$toast.center(this.$t("login.passwords"));
        return false;
      }
