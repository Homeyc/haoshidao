            ...
            <aside class="mail-nav mail-nav-bg-color nav_box">
                ...
                <div class="mail-nav-body">
                    <!-- <div style="position: relative;" v-show="userType!=1">
                         <img class="" @click="changeMenu(0)" style="position: absolute;top: 0px;left:3.5px;width: 203px;height: 60px;cursor: pointer;" src="../assets/img/zcbtn@2x.png" >
                         <img class="" @click="cretaUm" style="position: absolute;top: 75px;left:3.5px;width: 203px;height: 60px;cursor: pointer;" src="../assets/img/zcbtn@2x.png" >
    ...
    export default {
        ...
        methods: {
            ...
            checkMenu(){
                ...
                if(this.$route.path=='/robot/overview'){
                    this.sideMenu=1
                }else if(this.$route.path=='/robot/instance'){
                    this.sideMenu=2
                }else if(this.$route.path=='/robot/factory'){
                    this.sideMenu=3
                }else if(this.$route.path=='/robot/warehouse'){
                    this.sideMenu=4
                }else if(this.$route.path=='/robot/component'){
                    this.sideMenu=5
                }else if(this.$route.path=='/robot/myStrategy'){
                    this.sideMenu=6
                }
            },
            cretaUm(){
